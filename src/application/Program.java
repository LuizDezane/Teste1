...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * for (int i=0; i<N; i++) {
		 * 
		 * System.out.println(); System.out.println("Emplyoee #" + (i + 1) + ":");
		 * System.out.print("Id: "); Integer id = sc.nextInt(); while (hasId(list, id))
		 * { System.out.println("Id already taken! Try again: "); id = sc.nextInt(); }
		 * 
